...
# Copyright 2022 The Nho Luong DevOps
#
...
PROM_OPERATOR_VERSION=${PROM_OPERATOR_VERSION:-v0.73.2} # cf https://github.com/nholuongut/prometheus-operator/releases
...
kubectl apply -f "https://github.com/nholuongut/prometheus-operator/releases/download/${PROM_OPERATOR_VERSION}/bundle.yaml" --server-side
